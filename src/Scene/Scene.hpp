...
public:
  ...
  const std::vector<std::unique_ptr<Object>> &getObjects(void) const {
    return _objects;
  }
  const std::vector<std::unique_ptr<ILight>> &getLights(void) {
    return _lights;
  }
...
private:
  ...
  void insertObjInObjects(const libconfig::Setting &s,
                          std::vector<std::unique_ptr<Object>> &objects);
  void readObject(const libconfig::Setting &s,
                  std::vector<std::unique_ptr<Object>> &objects);
  void readLight(const libconfig::Setting &s,
