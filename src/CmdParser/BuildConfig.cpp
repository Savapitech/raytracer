...
void Parser::initParser(void) {
  ...
  bindField(_config.output, "output");
  bindField(_config.gui, "gui");
  bindField(_config.clusterServer, "server");
  bindField(_config.clusterSlave, "slave");
...
const CmdConfig::config_t &Parser::getConfig() const { return _config; }
} // namespace ParserCmd