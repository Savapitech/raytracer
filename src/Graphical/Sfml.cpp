...
bool Sfml::isOpen(void) { return _window.isOpen(); }

void Sfml::addSprite(sf::Sprite &sprite) { _spriteTab.push_back(sprite); }
...
bool Sfml::handleMovement(scene::Scene &scene) {
  ...
  if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Q)) {
    scene.updateCamera(
        {cam.pos.x + static_cast<float>(-0.2), cam.pos.y, cam.pos.z});
    move = true;
  }
  ...
  if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::S)) {
    move = true;
    scene.updateCamera(
        {cam.pos.x, cam.pos.y, cam.pos.z + static_cast<float>(-0.2)});
  }
  ...
  if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Up)) {
    move = true;
    scene.updateCamera(
        {cam.pos.x, cam.pos.y + static_cast<float>(0.2), cam.pos.z});
  }
